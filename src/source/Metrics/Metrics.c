...
STATUS getDataChannelStats(PRtcPeerConnection pRtcPeerConnection, PRtcDataChannelStats pRtcDataChannelStats)
{
    ...
    pRtcDataChannelStats->bytesReceived = __atomic_load_n(&pKvsDataChannel->atomicBytesReceived, __ATOMIC_RELAXED);
    pRtcDataChannelStats->bytesSent = __atomic_load_n(&pKvsDataChannel->atomicBytesSent, __ATOMIC_RELAXED);
