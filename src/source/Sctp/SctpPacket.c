...
UINT32 sctpWriteInitAckChunk(PBYTE pBuf, UINT32 initTag, UINT32 arwnd, UINT16 numOutStreams, UINT16 numInStreams, UINT32 initialTsn, PBYTE pCookie,
                             UINT32 cookieLen)
{
    UINT32 chunkLen;
    UINT32 offset = 0;
...
UINT32 sctpWriteDataChunk(PBYTE pBuf, UINT32 tsn, UINT16 streamId, UINT16 ssn, UINT32 ppid, BOOL unordered, PBYTE pPayload, UINT32 payloadLen)
{
