...
TEST_F(DataChannelFunctionalityTest, dataChannelFloodSend)
{
    ...
    const UINT32 FLOOD_MESSAGE_COUNT = 1000;
    const UINT32 FLOOD_MESSAGE_SIZE = 32;
...
TEST_F(DataChannelFunctionalityTest, dataChannelConcurrentSends)
{
    ...
    const UINT32 MESSAGES_PER_THREAD = 250;
    const UINT32 TOTAL_MESSAGES = NUM_THREADS * MESSAGES_PER_THREAD;
    const UINT32 MSG_SIZE = 32;
