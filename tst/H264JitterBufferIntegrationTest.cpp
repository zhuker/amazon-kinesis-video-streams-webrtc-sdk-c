...
protected:
    ...
    static STATUS h264FrameReadyCallback(UINT64 customData, UINT16 startIndex, UINT16 endIndex, UINT32 frameSize)
    {
        ...
        DLOGI("Frame ready callback: startIndex=%u, endIndex=%u, frameSize=%u", startIndex, endIndex, frameSize);
        ...
        if (STATUS_SUCCEEDED(status) && filledSize == frameSize) {
            ...
            DLOGI("Received frame %u, size %u, startSeq=%u", pTest->mTotalFramesReceived, frameSize, startIndex);
        } else {
    ...
    static STATUS h264FrameDroppedCallback(UINT64 customData, UINT16 startIndex, UINT16 endIndex, UINT32 timestamp)
    {
        ...
        DLOGI("Frame dropped callback: startIndex=%u, endIndex=%u, timestamp=%u", startIndex, endIndex, timestamp);
