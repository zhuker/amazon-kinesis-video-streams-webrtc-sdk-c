...
static UINT32 buildDataPacket(PBYTE buf, UINT16 srcPort, UINT16 dstPort, UINT32 vtag, UINT32 tsn, UINT16 sid, UINT16 ssn, UINT32 ppid, BOOL unordered,
...
static UINT32 buildSackPacket(PBYTE buf, UINT16 srcPort, UINT16 dstPort, UINT32 vtag, UINT32 cumTsn, UINT32 arwnd, PUINT16 gapStarts, PUINT16 gapEnds,
                              UINT16 numGaps)
{
    UINT32 off = sctpWriteCommonHeader(buf, srcPort, dstPort, vtag);
...
static UINT32 buildDataPacketWithFlags(PBYTE buf, UINT16 srcPort, UINT16 dstPort, UINT32 vtag, UINT32 tsn, UINT16 sid, UINT16 ssn, UINT32 ppid,
                                       UINT8 flags, PBYTE payload, UINT32 payloadLen)
{
    UINT32 off = sctpWriteCommonHeader(buf, srcPort, dstPort, vtag);
